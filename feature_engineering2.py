...
model = gensim.models.KeyedVectors.load_word2vec_format('data/facebookfasttext.vec', binary=False) # GoogleNews-vectors-negative300.bin.gz
...
data.to_csv('data/fast_test_features.csv', index=False)
