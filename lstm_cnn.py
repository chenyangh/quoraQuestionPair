...
########################################
BASE_DIR = 'data/'
EMBEDDING_FILE = BASE_DIR + 'glove.840B.300d.txt' #  'facebookfasttext.vec' #  # #
...
preds = model.predict([test_data_1, test_data_2, test_leaks], batch_size=1024, verbose=1)
preds += model.predict([test_data_2, test_data_1, test_leaks], batch_size=1024, verbose=1)
preds /= 2
